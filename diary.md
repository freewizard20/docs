...
- 그래도 레이팅 일을 한시간정도 받았다. 제대로 못하고 있는 것 같기는 하다. 더 잘해야지. 노력하고 있는데 쉽게 생각하면 쉬워 보이지만 사실 생각보다 많이 어렵다. 내 느낌대로 하는게 아니기 때문에.. 해외의 기준표를 가지고 국내의 기준을 판단해야 한다.
- 웨일 브라우저로 갈아탔다. 결과는 대만족. 정말 세부적인 부분까지 노력을 많이 한 티가 난다. 잘 만든 소프트웨어. 웨일 브라우저가 잘만 한다면 네이버가 앞으로 생존하는데 큰 도움이 될 듯 싶다(브라우저 전쟁).
